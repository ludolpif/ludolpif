...
```
root@lud-5490:~# apt install build-essential chromium curl fonts-noto-core iftop iotop git gmidimonitor gimp
root@lud-5490:~# apt install hunspell-fr-revised inotify-tools jq keepassxc mate-calc oathtool rsync ssh
root@lud-5490:~# apt install strace uvcdynctrl vim xarchiver
...
ludolpif@lud-5490:~/.config$ pw-jack ardour
```
